...
var _0 = new Buffer(16)
var _9 = new Buffer(32)
_9[0] = 9
...
function crypto_sign_detached(sig, m, sk) {
  var sm = new Buffer(m.length + crypto_sign_BYTES)
  crypto_sign(sm, m, sk)
...
function crypto_secretbox_detached(o, mac, msg, n, k) {
  ...
  var tmp = new Buffer(msg.length + mac.length)
...
function crypto_secretbox_open_detached(msg, o, mac, n, k) {
  check(mac, sodium.crypto_secretbox_MACBYTES)
  var tmp = new Buffer(o.length + mac.length)
  tmp.set(o)
...
function crypto_secretbox_easy(o, msg, n, k) {
  ...
  var i
  var m = new Buffer(crypto_secretbox_ZEROBYTES + msg.length)
