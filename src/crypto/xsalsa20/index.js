...
XSalsa20.prototype.update = function(input, output) {
  if (!input) throw new Error('input must be Buffer or Buffer')
  if (!output) output = new Buffer(input.length)
...
function Fallback(nonce, key) {
  this._s = new Buffer(32)
  this._z = new Buffer(16)
  this._overflow = 0
